      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-10 md:gap-9 px-5 md:px-20 py-10">
        ...
        <div className="flex flex-col justify-center md:items-end items-center w-full md:w-1/2 xl:w-full gap-3 order-2 md:order-1">
          <div className="flex flex-col gap-1 w-full md:w-full text-center md:p-5 md:pt-5 lg:pt-15 p-2 md:text-left ">
            ...
            <div className="flex flex-wrap md:flex-nowrap w-auto gap-2 md:gap-4 justify-center md:justify-start text-2xl md:text-2xl lg:text-3xl xl:text-5xl font-bold leading-tight text-gray-100">
              <span className="">I'M</span>
              <span className="text-purple-700 whitespace-nowrap">Cahya Yoga</span>
              <span>Ariyanto</span>
            </div>
            
            <div className="flex flex-row gap-2 md:gap-5 mt-2 md:justify-start justify-center md:mt-6">
                <Icon nama="ig" link="https://www.instagram.com/ygartn_/" color="red" size={30} />
                <Icon nama="linkedin" link="https://www.linkedin.com/in/cahya-yoga-ariyanto-8b5139261/" color="blue" size={30} />
                <Icon nama="github" link="https://github.com/CahyaYogaAriyanto" color="white" size={30} />
                <Icon nama="gmail" link="https://mail.google.com/mail/?view=cm&fs=1&to=yogakecol123@gmail.com" color="red" size={30} />
            </div>
